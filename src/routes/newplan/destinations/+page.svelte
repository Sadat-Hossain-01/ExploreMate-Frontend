<script lang="ts">
    ...
    $: {
        ...
        filtered_suggestions = destination_suggestions.filter(
            (destination: any) =>
                destination.name
                    .toLowerCase()
                    .includes(search_input.toLowerCase())
        );
        filtered_selections = destination_selections.filter(
            (destination: any) =>
                destination.name
                    .toLowerCase()
                    .includes(search_input.toLowerCase())
        ...
        console.log("dest|current_mapitems", current_mapitems);
    }
</script>
